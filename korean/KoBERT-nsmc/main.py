...
def main(args):
    ...
    trainer = Trainer(args, dataset, dev_dataset, test_dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_seq_len", default=64, type=int, help="The maximum total input sequence length after tokenization.")
